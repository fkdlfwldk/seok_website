      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <option value="SEO 진단만">SEO 진단만</option>
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-3 cursor-pointer group">
            <input
              ...
              className="mt-1 w-5 h-5 rounded border-emerald-500/30 bg-black/30 text-emerald-500 focus:ring-emerald-500/50 focus:ring-offset-0 cursor-pointer"
            />
